...
@section('content')
<form action="{{ url('/group-section') }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="modal-body">
  <div class="form-group">
    ...
    <div style='display:inline-block; width: 70%; border-bottom:1px solid #030399;'>
        <label for="recipient-name" class="col-form-label">DIVIDE CADETS INTO GROUP OF:</label>
        <input type="text" class="form-control" name="divisor" id="recipient-name">
  </div>
</div>
</div>
</div>
