...
@section('content')
<form action="/save-cadetcrse" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="modal-body">
  <div class="form-group">
    ...
    <div class="form-group">
        ...
        <select name="courses_id" class="form-control">
            <option value="">CHOOSE CCODE</option>
      ...
      <div class="form-group">
        ...
        <select name="cadets_id" class="form-control">
            <option value="">CHOOSE CADETSN</option>
  ...
  <div class="form-group">
    ...
    <input type="text" name="term" class="form-control" id="recipient-name">
  </div>
  <div class="form-group">
    <label for="message-text" class="col-form-label">ACADYR</label>
    <input type="text" name="acadyr" class="form-control" id="recipient-name">
  </div>
  <div class="form-group">
    <label for="message-text" class="col-form-label">CLASS</label>
    <input type="text" name="class" class="form-control" id="recipient-name">
  </div>
